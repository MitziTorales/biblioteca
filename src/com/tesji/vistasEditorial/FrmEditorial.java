 ...
 */
package com.tesji.vistasEditorial;

import com.tesji.modelo.Editorial;
...
public class FrmEditorial extends javax.swing.JFrame {
    ...
    private void altaCategoria(){
        ...
        if(nombre.trim().length()==0){
            JOptionPane.showMessageDialog(rootPane, "El campo nombre no debe"
                    + "estar vacio\nIntente de nuevo",
                    "Alta Editorial",JOptionPane.ERROR_MESSAGE);
            txtNombre.requestFocus();
        }else if (pais.trim().length()==0){
            JOptionPane.showMessageDialog(rootPane, "El campo pais paterno no debe"
                    + "estar vacio\nIntente de nuevo",
                    "Alta Autor",JOptionPane.ERROR_MESSAGE);
            txtPais.requestFocus();
        }else if (fecha.trim().length()==0){
            JOptionPane.showMessageDialog(rootPane, "El campo fecha materno no debe"
                    + "estar vacio\nIntente de nuevo",
                    "Alta Autor",JOptionPane.ERROR_MESSAGE);
            ...
            if(autor.alta(nombre,pais,fecha)){
                JOptionPane.showMessageDialog(rootPane, "Editorial registrada correctamente");
                inhabilitar();
            }else{
    ...
    private void initComponents() {
        ...
        jLabel1.setText(".:: ALTA EDITORIAL ::.");
